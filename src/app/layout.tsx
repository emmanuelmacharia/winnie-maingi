...
export const metadata: Metadata = {
  title: "Winnie Maingi",
  description: "Winnie Maingi is an experienced estate planner, trust practitioner, and lawyer specializing in trust and family law, estate planning, and family business advisory.",
